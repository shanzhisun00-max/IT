...
<style>
    ...
    .metric-card { 
        ...
        max-width: 240px; /* 强制限制卡片最大宽度，让它显得更小 */
        height: 180px
        display: flex;
...
# 核心修改：在 st.columns 中加入 gap="middle"，让左右间距彻底拉开
# --- 第一排 ---
r1 = st.columns(5, gap="middle")
